...
BoltSpell::BoltSpell(NewSpellPayload payload, SpellData *_data){
...
void BoltSpell::DrawUI() {

}

void BoltSpell::OnLifetimeTimeout() {
    should_delete = true;
}

float BoltSpell::GetYSort() {
    return position.y;
}

void BoltSpell::TakeDamage(DamagePayload _payload) {
