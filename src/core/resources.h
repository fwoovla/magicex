...
/*     ITEM_ID_PURPLERAIN,
    ...
    ITEM_ID_SCROLL,
    ITEM_ID_SWIFTNESS_SCROLL,
    ITEM_ID_DAMAGE_SCROLL,
    ITEM_ID_TOUGHNESS_SCROLL,
    ITEM_ID_RESIST_SCROLL,

    ITEM_ID_CHARM,
    ITEM_ID_SWIFTNESS_CHARM_1,
    ITEM_ID_SWIFTNESS_CHARM_2,
    ITEM_ID_SWIFTNESS_CHARM_3,
    ITEM_ID_SWIFTNESS_CHARM_4,
    ITEM_ID_SWIFTNESS_CHARM_5,

    ITEM_ID_DAMAGE_CHARM_1,
    ITEM_ID_DAMAGE_CHARM_2,
    ITEM_ID_DAMAGE_CHARM_3,
    ITEM_ID_DAMAGE_CHARM_4,
    ITEM_ID_DAMAGE_CHARM_5,

    ITEM_ID_TOUGHNESS_CHARM_1,
    ITEM_ID_TOUGHNESS_CHARM_2,
    ITEM_ID_TOUGHNESS_CHARM_3,
    ITEM_ID_TOUGHNESS_CHARM_4,
    ITEM_ID_TOUGHNESS_CHARM_5,

    ITEM_ID_RESIST_CHARM_1,
    ITEM_ID_RESIST_CHARM_2,
    ITEM_ID_RESIST_CHARM_3,
    ITEM_ID_RESIST_CHARM_4,
    ITEM_ID_RESIST_CHARM_5,
...
enum SpellID {
    SPELL_ID_NONE = -1,
    SPELL_ID_MAGICMISSLE_WAND,
    SPELL_ID_FIREBALL_WAND,
    SPELL_ID_LIGHTNING_WAND,
    SPELL_ID_POISON_WAND,
    SPELL_ID_MAGICMISSLE_STAFF,
    SPELL_ID_FIREBALL_STAFF,
    SPELL_ID_LIGHTNING_STAFF,
    SPELL_ID_POISON_STAFF,
    SPELL_ID_MAX
};
